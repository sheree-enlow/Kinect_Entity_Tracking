...
Entity::Entity(cv::Rect bdRect,ushort floorDist,cv::Mat img) {



	currentBoundingRect = bdRect;
	...
	blnCurrentMatchFoundOrNewEntity = true;
  
    heights.push_back(((int64_t)floorDist - img.at<ushort>(currentCenter)));// heights

	intNumOfConsecutiveFramesWithoutAMatch = 0;
	
	outerCir = innerCir = false;
}


void Entity::predictNextPosition(void) {
